...
const queries = {
  forumMessages: async (root: undefined, args: Record<string, string>): Promise<IForumMessageDocument[]> => {
...
const mutations = {
  postMessage: async (root: undefined, args: Record<string, string>): Promise<IForumMessageDocument> => {
